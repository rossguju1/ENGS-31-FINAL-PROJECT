...
#
# Generated by export_simulation on Tue May 29 16:05:38 -0400 2018
#
################################################################################
...
'-reset_run' switch to the './old_state_RAM.sh' script.

./old_state_RAM.sh -reset_run
...
./old_state_RAM.sh -noclean_files

For more information on the script, please type './old_state_RAM.sh -help'.
