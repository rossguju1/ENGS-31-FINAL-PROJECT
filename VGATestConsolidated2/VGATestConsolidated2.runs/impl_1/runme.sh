...
HD_PWD='O:/Documents/VGATestConsolidated2/VGATestConsolidated2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGATestTopLevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGATestTopLevel.tcl -notrace
