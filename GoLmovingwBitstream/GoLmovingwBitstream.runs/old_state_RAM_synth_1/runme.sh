...
HD_PWD='O:/Documents/GameOfLifeDisplay/GameOfLifeDisplay.runs/old_state_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log old_state_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source old_state_RAM.tcl
